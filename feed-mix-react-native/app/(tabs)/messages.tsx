import { CONVERSATIONS, ConversationType } from "@/data";
...
const MessagesScreen = () => {
  ...
  return (
    <SafeAreaView className="flex-1 bg-white" edges={["top"]}>
      ...
      {/* Search Bar */}
      <View className="relative px-4 py-3 border-b border-gray-100">
        <Feather
          name="search"
          size={20}
          color="#657786"
        ...
        <TextInput
          className={`flex-1 pl-9 pr-4 py-2 text-base bg-gray-100 focus:ring-1 focus:ring-blue-500 focus:outline-none ${newMessage.trim() ? "rounded-xl" : "rounded-full"}`}
      ...
      >
        {selectedConversation && (
          <SafeAreaView className="flex-1">
            ...
            {/* Message Input */}
            <View className="flex-row items-center px-4 py-3 border-gray-100 gap-4">
              <TextInput
                className={`flex-1 text-base px-4 py-2 bg-gray-100 focus:ring-1 focus:ring-blue-500 focus:outline-none ${newMessage.trim() ? "rounded-xl" : "rounded-full"}`}
                placeholder="Type a message..."
                placeholderTextColor="#657786"
                value={newMessage}
                onChangeText={setNewMessage}
                multiline={newMessage.trim() ? true : false}
              />

              <TouchableOpacity
                onPress={sendMessage}
                className={`self-end size-8 rounded-full items-center justify-center ${
